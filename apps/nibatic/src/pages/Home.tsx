...
import {Code2, Lightbulb, Brain, Code, PenTool, MessageCircle, DatabaseIcon, GitPullRequestArrow, Handshake, ArrowRight} from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className="bg-blue-800 w-full p-6" style={{height: '100vh'}}>
                <NavBar />
                <div className="flex justify-between bg-opacity-55" style={{width: '90%', margin: '0 auto',}}>
                    <div className=" mr-6">
                        <div className="">
                            <img src={img0} alt="" className="mt-8 opacity-30 rounded-2xl object-contain max-w-2xl max-h-screen"/>
                            <div className="absolute p-2 ml-16" style={{transform: 'translateY(-120%)', maxWidth: '40rem'}}>
                                <h1 className=" font-bold text-white text-6xl mt-20 ">Institut de</h1>
                                <h1 className=" font-bold text-white text-6xl">Recherche & de formation</h1>
                                <h1 className=" font-bold text-white text-4xl">Des métiers du numériques</h1>
            ...
            <div className="content bg-white">
                ...
                <div className="second-element">
                    ...
                    <div className="text-content">
                        <div className="flex justify-center items-center">
                            ...
                            <h1 className="interest-header">LA RECHERCHE DANS LE NUMÉRIQUE</h1>
                        </div>
                ...
                <div className="third-element">
                    <h1 className="text-center font-bold text-3xl mt-10">Cursus disponibles</h1>
                        ...
                        <div className="service-container">
                            <div className="card">
                                ...
                                <div className="" style={{width: '100%'}}>
                                    ...
                                    <div className="text-center mb-2 self-end">
